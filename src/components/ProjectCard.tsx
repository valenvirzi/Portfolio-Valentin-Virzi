...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <article className="flex flex-col gap-3 overflow-hidden rounded bg-white pb-4 shadow-[0px_3px_6px_0_rgba(0,0,0,0.24)]">
      <img
      ...
      <div className="flex items-center justify-between gap-2 px-4 text-sm">
        ...
        <a
          className="rounded border bg-white px-4 py-2 text-black lg:px-8"
